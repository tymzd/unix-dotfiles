# Generated by Powerlevel10k configuration wizard on 2023-05-09 at 16:53 AEST.
...
# flat tails, 2 lines, solid, left frame, sparse, fluent, transient_prompt,
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    # =========================[ Line #1 ]=========================
    git_commit_message      # git status, custom. Shows current commit message.
  ...
  # Default background color (empty = transparent, adapts to both light & dark terminal themes).
